...
| v2 (Splinky v2) | `qmk compile -kb bastardkb/tbkmini/v2/splinky_2 -km default`  | `qmk compile -kb bastardkb/tbkmini/v2/splinky_2 -km via`  |
| v2 (Splinky v3) | `qmk compile -kb bastardkb/tbkmini/v2/splinky_3 -km default`  | `qmk compile -kb bastardkb/tbkmini/v2/splinky_3 -km via`  |
