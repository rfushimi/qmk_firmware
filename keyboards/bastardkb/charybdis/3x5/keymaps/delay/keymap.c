...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_NAVL] = LAYOUT_charybdis_3x5_delay(NAVL_split_3x5_3),
  [_NAVR] = LAYOUT_charybdis_3x5_delay(NAVR_split_3x5_3),
  [_SYML] = LAYOUT_charybdis_3x5_delay(SYML_split_3x5_3),
  [_SYMR] = LAYOUT_charybdis_3x5_delay(SYMR_split_3x5_3),
