...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [LAYER_NO_MODS_ALPHAS_COLEMAK_DHM] = LAYOUT_charybdis_3x5(
    LAYER_ALPHAS_COLEMAK_DHM_3x10, LAYER_NO_MODS_ALPHAS_THUMBS_1x6
  ),
#endif  // !KEYMAP_DEFAULT_LITE

  [LAYER_DEV] = LAYOUT_charybdis_3x5(LAYER_DEV_split_3x5_3),
...
layer_state_t layer_state_set_keymap(layer_state_t state) {
  ...
  charybdis_set_pointer_dragscroll_mode(current_layer == LAYER_DEV ||
