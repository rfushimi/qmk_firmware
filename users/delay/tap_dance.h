...
#    if defined(TD_ONESHOT_DRAGSCROLL_ENABLE) && defined(KEYBOARD_bastardkb_charybdis)
/** Dragscroll tap-dance state. */
typedef struct {
    (bool)(*get_pointer_dragscroll_enabled(void));
    (void)(*set_pointer_dragscroll_enabled(bool));
    td_state_t td_state;
...
#    if defined(POINTING_DEVICE_ENABLE) && defined(TD_ONESHOT_DRAGSCROLL_ENABLE) && defined(KEYBOARD_bastardkb_charybdis)
